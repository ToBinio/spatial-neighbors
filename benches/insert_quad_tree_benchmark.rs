...
pub fn insert_benchmark(c: &mut Criterion) {
    ...
    for size in [500, 2_000, 5_000].iter() {
        group.bench_with_input(BenchmarkId::new("QuadTree10", size), size, |b, size| {
            ...
            b.iter(|| {
                let mut quad_tree = QuadTree::with_capacity(-size as f64..size as f64, -size as f64..size as f64, 10);
        ...
        group.bench_with_input(BenchmarkId::new("QuadTree25", size), size, |b, size| {
            ...
            b.iter(|| {
                let mut quad_tree = QuadTree::with_capacity(-size as f64..size as f64, -size as f64..size as f64, 25);
        ...
        group.bench_with_input(BenchmarkId::new("QuadTree50", size), size, |b, size| {
            ...
            b.iter(|| {
                let mut quad_tree = QuadTree::with_capacity(-size as f64..size as f64, -size as f64..size as f64, 50);
